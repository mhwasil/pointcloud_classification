...
g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so_bitbots.so -shared -fPIC -I $TF_INC -I /usr/local/cuda-9.2/include -I $TF_INC/external/nsync/public -lcudart -L /usr/local/cuda-9.2/lib64/ -L $TF_LIB -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=1
