...
sys.path.append(os.path.join(BASE_DIR, '../utils/pointnet2/utils'))

import tensorflow as tf
import numpy as np
import pointnet2_util as tf_util
from pointnet2_modules import pointnet_sa_module
...
def get_model(point_cloud, is_training, bn_decay=None, num_class=49):
